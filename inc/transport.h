...
#define WHAD_TRANSPORT_FRAME_HEADER_SIZE 4
#define WHAD_MAX_ENCODED_MESSAGE_SIZE (WHAD_RINGBUF_CAPACITY - WHAD_TRANSPORT_FRAME_HEADER_SIZE)
#define WHAD_TRANSPORT_MSG_MAXSIZE WHAD_MAX_ENCODED_MESSAGE_SIZE
